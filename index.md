...
address: "DSC-Oasen, Georg Sverdrups hus, Moltke Moes vei 39, 0851 Oslo"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "59.938936"     # decimal latitude of workshop venue - this should be a number greater than or equal to -90, and less than or equal to 90 (use https://www.latlong.net/)
longitude: "10.721142"    # decimal longitude of the workshop venue - this should be a number greater than or equal to -180, and less than or equal to 180 (use https://www.latlong.net)
humandate: "Oct 27 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2026-10-27        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Federico Bianchini", "Camilla Holm Soelseth", "Erik Holten"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Hannah Sanderson"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
